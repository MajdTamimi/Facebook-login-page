...
const login = () => {
  ...
  return (
    <>
      <div>
        <div className="bg-[#f0f2f5] flex flex-col lg:flex-row min-w-full pb-[112px] pt-8 lg:pt-[72px] lg:w-[1512px] lg:h-[710px] justify-center lg:gap-20 lg:items-start items-center">
